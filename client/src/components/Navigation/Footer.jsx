  ...
  return (
    <footer className="bg-white dark:bg-gray-900">
      <div className="mx-auto max-w-full">
        <div className="grid grid-cols-2 gap-8 px-6 py-3 lg:py-8 md:grid-cols-5">
          <div className="my-auto justify-items-start m-0">
            <img
              src={logo}
              width={200}
              height={30}
              ...
              alt="D3LT409 Logo"
            />
            <div className="flex pt-3 space-x-3 justify-start mx-4">
              <Link
                to="#"
              ...
              >
                ...
                <span className="sr-only">LinkendId page</span>
              </Link>
              <Link
                to="#"
                className="text-gray-400 hover:text-gray-900 dark:hover:text-white"
        ...
        <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-center">
          <span className="text-md text-gray-500 dark:text-gray-300 md:text-center px-10">
            © 2023 <Link to="/">d3lt409™</Link>. All Rights Reserved.
          </span>
        </div>
      </div>
    </footer>
